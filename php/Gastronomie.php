    ...
    <header>
        ...
        <div class="responsive-menu">
            <section id="home" class="homme1">
                ...
                <h2>Bienvenue sur notre page gastronomique</h2>
                <h4>où les saveurs se transforment en voyage</h4>
                <a href="#" class="btn-reservation home-btn">Réserver Maintenant</a>
                <div class="find_trip">
                    <div class="card " id="card1"><img id="img1" src="../image/Images_garstronomie/hhH.jpg"></div>
                    <div class="card" id="card2"><img id="img2" src="../image/Images_garstronomie/istockphoto-690837746-612x612.webp"></div>
                    <div class="card" id="card3"><img id="img3" src="../image/Images_garstronomie/D3.jpg"></div>
                </div>
        </div>
        </section>
        </div>
