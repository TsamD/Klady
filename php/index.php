...
<body>
    ...
    <div class="containerind">
        ...
        <p class="hello">Explorez le monde avec Travelink - votre guide ultime pour des aventures inoubliables ! <br><span>Veuillez-vous connecter svp </span> </p>
        <!-- <p class="hello"></p> -->
        <section>
        ...
        <div class="container">
            ...
            <div class="row" style="margin-top: 50px;">
                ...
                <div class="col-md-6 py-3 py-md-0">
                    ...
                    <a href="https://interface3.be/fr"><button id="about-btn"> Plus...</button></a>
                </div>
            </div>
        </div>
    </section>
