...
<body>
    ...
    <div class="carousel">
        ...
        <div class="slide">
            <h2 class="write-animation">ZANZIBAR<p class="write-animation text-white">
                    <span style="--delay: 1;">Voyage en</span>
                    <span style="--delay: 3;">été</span>
                </p>
                <!-- <a href="maldive.php"><button class="bou">Connexion </button> </a> -->
            </h2>
            <div class="slide-content">
        ...
        <div class="slide">
            <h2 class="write-animation"> ECOSSE<p class="write-animation text-white">
                    ...
                    <span style="--delay: 3;">automne</span>
                </p>
                <!-- <a href="maldive.php"><button class="bou">Connexion </button> </a> -->
            </h2>
            <div class="slide-content">
    ...
    <section class="book" id="book">
        <div class="container">
            ...
            <div class="main-text">
                <h1><img src="../image/logonoir.png" width="200px" style="margin-bottom: 4.5rem;" alt=""> en quelques
                    mots</h1>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 py-3 py-md-0 ">
                    <div class="carde">
                        <img src="../image/ACCU.avif" style="margin-right:5rem; width:100%;" alt="">
                ...
                <div class="col-md-6 py-3 py-md-0">
                    <div class="scrollable">
                        ...
                        <p>
                            Agence de voyage et de rencontres spécialisée dans la création d'expériences uniques et
                            mémorables pour nos clients.
                    ...
                    <a href="reservation.php" style="margin-top: 3rem;" target="_blank"><button id="about-btn">Reservez
                            ici</button></a>
            ...
            <div class="testimonial-box">
                ...
                <div class="client-comment">
                    <p>
                        ...
                        Les destinations, les hébergements et l'ensemble de l'itinéraire ont dépassé toutes mes
                        attentes.
        ...
        <div class="container">
            ...
            <div class="row" style="margin-top: 50px;">
                ...
                <div class="col-md-6 py-3 py-md-0">
                    ...
                    <a href="https://interface3.be/fr" target="_blank"><button id="about-btn"> Plus...</button></a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="containe">
                ...
                <div class="contact-image">
                    <img class="imgContact" src="../image/contacter.jpg" height="60%" alt="Image de contact">
                </div>

                <div class="contact-form">
                    <div class="main-text">
                        <h1><span>N</span>ous contacter</h1>
                    </div>
    ...
    <footer id="footer">
        ...
        <div class="credit">
            <p>Produit <a href="https://www.bruxellesformation.brussels/annuaire/interface3/" style="color:#ff6600"
                    target="_blank"> Interface 3 </a></p>
        </div>
        <div class="copyright">
