...
<body>
    <!-- Navbar Start -->
    <nav class="navbar navbar-expand-lg sticky-top sticky-top" id="navbar">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="mynavbar">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="HOME2.php#packages">Destination</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="HOME2.php#services">Services</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="HOME2.php#gallary">Contact</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="HOME2.php#about">A propos</a>
                    </li>
                </ul>
    ...
    <div class="carousel">
        <div class="slide">
            <h2 class="slogan">MALDIVES <br /></h2>

            <img src="../image/desti/Kandolhu-Island.jpg" alt="Image 1" />
        </div>

        <div class="slide">
            <h2 class="slogan">MALDIVES</h2>
                ...
                <div class="col-md-6 py-3 py-md-0">
                    <div class="scrollabless">
                        ...
                        <p class="anime">
                            ...
                            inclure des activités culturelles, des spectacles de
                            cabaret, des croisières
                        </p>
                        ...
                        <p class="anime">
                            ...
                            bénéficierez d'une assistance 24/h sur24.
                        </p>
                    ...
                    <a href="reservation.php" target="_blank" style="margin-top: 5rem;"><button id="about-btn">Reservez ici</button></a>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="fixed-text"> <a href="Maldive.php" style="color: aliceblue;"><span>M</span>
            <span>a</span>
            <span>l</span>
            <span>d</span>
            <span>i</span>
    ...
    <div class=" container">
        ...
        <div class="row" style="margin-top: 30px;">
            ...
            <div class="col-md-6 py-3 py-md-0">
                <iframe class="relative flex items-center justify-center h-96 w-screen-xl  overflow-hidden" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d8159199.921096209!2d67.94091904996493!3d3.09882189467529!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x24b599bfaafb7bbd%3A0x414509e181956289!2sMaldives!5e0!3m2!1sfr!2sbe!4v1695593016139!5m2!1sfr!2sbe" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
    ...
    <section class="packages" id="packages">
        <div class="container">
            ...
            <div class="row" style="margin-top: 30px">
                <div class="col-md-4 py-3 py-md-0">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="Acti-Maldive.php">Découvrez plus</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 py-3 py-md-0">
                    <div class="card">
                        <img src="../image/ZZ6.jpg" alt="maison" />
                        <div class="card-body">
                            <h3>Hébergement aux Maldives</h3>
    ...
    <section class="Gallary" id="Gallary">
        <div class="container">
            <div class="main-text">
                <h1>Q<span>uelques iles Maldives</span></h1>
            </div>
