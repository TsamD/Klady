                    ...
                    <form action="code-reservation.php" method="Post" class="formR">
                        <div class="boxi">
                            ...
                            <option     name="destination"     value="Ecosse" >Ecosse</option>
                                ...
                                <select name="destination" id="destination" required>
                                    <option value="destination" data-image="../image/Maldive.jpg">Destination :</option>
                                    <option value="Maldives" data-image="../image/MAL.jpg">Maldives</option>
                                    <option value="Zanzibar" data-image="../image/léopard.jpg.">Zanzibar</option>
                                    <option value="Ecosse" data-image="../image/ecolo4.jpg">Ecosse</option>
                                </select>
                            </div>
                            <div class="coli">
